...
// with the given ID and returns any error encountered.
...
// PostResourceWebhook creates a new webhook associated to Resource and
...
// PostSingleResourceWebhook creates a new webhook associated to Resource and
// returns any error encountered.
